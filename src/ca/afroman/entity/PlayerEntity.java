...
public class PlayerEntity extends DrawableEntityDirectional
{
	...
	{
		super(isServerSide, -1, getUp(isServerSide, role), getDown(isServerSide, role), getLeft(isServerSide, role), getRight(isServerSide, role), getIdleUp(isServerSide, role), getIdleDown(isServerSide, role), getIdleLeft(isServerSide, role), getIdleRight(isServerSide, role), pos, new Hitbox(true, 3, 5, 10, 11));
