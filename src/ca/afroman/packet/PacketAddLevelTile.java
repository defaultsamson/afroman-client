...
public class PacketAddLevelTile extends Packet
{
	 ...
	 */
	public PacketAddLevelTile(int layer, LevelType level, Entity entity)
	{
	...
	public byte[] getData()
	{
		return (type.ordinal() + "," + id + Packet.SEPARATOR + entity.getID() + "," + level.ordinal() + "," + layer + "," + (entity.getAssetType() != null ? entity.getAssetType().ordinal() : AssetType.INVALID.ordinal()) + "," + entity.getX() + "," + entity.getY() + (entity.hasHitbox() ? "," + entity.hitboxesAsSaveable() : "")).getBytes();
	}
}
