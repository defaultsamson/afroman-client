...
public enum AssetType
{
	...
	TILE_DOOR_RIGHT_TOP_CLOSED(true),
	TILE_DOOR_RIGHT_TOP_OPEN(true),
	TILE_DOOR_RIGHT_BOTTOM_CLOSED(true),
	TILE_DOOR_RIGHT_BOTTOM_OPEN(true),
	TILE_DOOR_DOWN_CLOSED(true),
	TILE_DOOR_DOWN_OPEN(true),
	TILE_DOOR_LEFT_TOP_CLOSED(true),
	TILE_DOOR_LEFT_TOP_OPEN(true),
	TILE_DOOR_LEFT_BOTTOM_CLOSED(true),
	TILE_DOOR_LEFT_BOTTOM_OPEN(true),
	...
	ITEM_HOLDER(false),
	ITEM_HAIRPIN_SMALL(true),
	ITEM_HAIRPIN_LARGE(false),
	ITEM_KNUCKLES_SMALL(true),
	ITEM_KNUCKLES_LARGE(false),
